...
void Clear::Init() {
	...
	// 座標の初期化
	m_player1_pos = { (WINDOW_W_F / 2) - 256, 1000 };
	m_player2_pos = { (WINDOW_W_F / 2) + 256, 1000 };

	m_background1_pos = { 0, (WINDOW_H_F - BACKGROUND_TEXTURE_SIZE_Y) };
	...
	// UIの変数初期化
	m_clear_ui_pos = { (WINDOW_W_F / 2), (m_player1_pos.y - 500) };
	m_clear_ui_size = 0;

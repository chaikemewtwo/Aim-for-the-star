...
Clear::Clear() {
	// プレイヤー1の画像登録
	m_player1_texture_list[SWIM_TEXTURE] = "Resource/Texture/Player/de_swim.png";
	...
	// プレイヤー2の画像登録
	m_player2_texture_list[SWIM_TEXTURE] = "Resource/Texture/Player/hi_swim.png";
...
void Clear::Init() {
	...
	m_player1_texture = m_player1_texture_list[SWIM_TEXTURE];
	m_player2_texture = m_player2_texture_list[SWIM_TEXTURE];
	m_background_texture = m_background_texture_list[SEA_TEXTURE];
	
	m_p1_pos = D3DXVECTOR2(760, 1070);
	m_p2_pos = D3DXVECTOR2(1160, 1070);
}
